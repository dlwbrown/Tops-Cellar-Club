...
**Signing out:** on the dashboard, tap **Sign out** (bottom of *Jump to*) to lock the admin and return to the member app. Closing the app also ends the session.
...
- **Discovery Boxes** — title, month, price, what's inside (one wine per line), availability, status, image.
